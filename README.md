...
- **جستجوی هدفمند** — فیلتر بر اساس جنسیت، بازه سنی، استان و شهر؛ انتخابِ استان بدونِ شهر مشکلی نداره (جستجو فقط بر اساسِ استان انجام می‌شه)، ولی انتخابِ شهر قبل از استان ممکن نیست و صراحتاً گفته می‌شه اول استان رو انتخاب کن. فیلترِ فاصله هم داره (همون گزینه‌های ۵/۱۰/۲۰/۵۰ کیلومتریِ «افراد نزدیک»، به‌علاوه‌ی «🎯 نزدیک‌ترین آدم ممکن»)؛ برای فعال‌کردنش باید قبلاً از بخشِ «افراد نزدیک» موقعیتت رو به اشتراک گذاشته باشی
...
- **فیلترِ شعاعی** — انتخابِ محدوده‌ی جستجو بینِ ۵، ۱۰، ۲۰، یا ۵۰ کیلومتری

- **لیستِ نتایج** — هر نتیجه با نام، لینکِ پروفایلِ عمومی (`/user_<code>`)، فاصله‌ی تقریبی، و وضعیتِ آنلاینی نمایش داده می‌شه؛ حداکثر ۵۰ نفر در هر شعاع، مرتب‌شده بر اساسِ زودترین آنلاینی (نه صرفاً نزدیک‌ترین فاصله)، با صفحه‌بندیِ ۲۰تایی و دکمه‌ی صفحه‌ی بعد/قبل
