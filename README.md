...
- **پاکسازی تاریخچه** — بعد از پایان هر چت، دکمه‌ی پاکسازیِ دوطرفه و دکمه‌ی گزارشِ گفتگو فقط ۲ دقیقه معتبرن (صراحتاً اعلام می‌شه)؛ بعد از ۲ دقیقه تاریخچه‌ی متنیِ سرور (برای قضاوتِ AI) خودکار پاک می‌شه بدونِ اینکه پیام‌های خودِ تلگرامِ کاربرها حذف بشه، و کلیک روی دکمه‌ها بعد از انقضا پیامِ «درخواست معتبر نیست» می‌ده
