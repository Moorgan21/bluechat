...
| کاربر همزمان آنلاین | ~۱,۸۰۰ | **Telegram API (30 msg/s)** |
| چت همزمان فعال | ~۱۰۰–۲۰۰ جفت | Python asyncio |
| اتصال همزمان به DB | حداکثر ۶۰ | `pool_size=20, max_overflow=40` |

> **سقف اصلی:** Telegram API به هر ربات ۳۰ پیام در ثانیه اجازه میده — این محدودیت برای همه ربات‌های تلگرام صدق می‌کنه و با تغییر کد قابل برطرف‌کردن نیست.
