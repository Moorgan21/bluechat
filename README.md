...
> **سقف اصلی:** محدودیت ۳۰ پیام در ثانیه Telegram برای همه ربات‌ها صدق می‌کنه. با فعال‌سازی **Paid Broadcast** در BotFather این سقف به ۱,۰۰۰ msg/s می‌رسه (نیاز به ۱۰۰K MAU و ۱۰۰K Star موجودی).
