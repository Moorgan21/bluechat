...
- **فیلترِ شعاعی** — انتخابِ محدوده‌ی جستجو بینِ ۵، ۱۰، ۲۰، یا ۵۰ کیلومتری، یا «🎯 نزدیک‌ترین آدم ممکن» که بدونِ هیچ محدودیتِ فاصله‌ای فقط تک‌نفرِ واقعاً نزدیک‌تر از همه رو نشون می‌ده
