...
- **مدیریتِ owner** — بستن/بازکردنِ اتاق برای عضوگیری، اخراجِ عضو، حذفِ پیامِ هرکسی، و حذفِ کاملِ اتاق (به‌همراه پیشنهادِ پاک‌سازیِ تاریخچه). وقتی اتاق بسته می‌شه، اعضای غیرِ owner به منوی اصلی (بدونِ تغییر) هدایت می‌شن و به بقیه‌ی امکاناتِ ربات (بجز چتِ ۱به۱ و اتاقِ جدید) دسترسیِ کامل دارن؛ با `/room` یا دکمه‌ی «🏠 اتاق چت» دوباره وارد اتاق می‌شن
