...
- **بلاکِ فرستنده** — صاحبِ لینک می‌تونه فرستنده رو برای همیشه بلاک کنه؛ بعدِ بلاک نه پیامِ ناشناسِ جدید تحویل داده می‌شه نه ادامه‌ی زنجیره‌ی پاسخ‌ها (حتی اگه فرستنده از دکمه‌ی «↩️ پاسخ دادن» زیرِ یه پاسخِ قبلی استفاده کنه)
