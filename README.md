...
- **جلوگیری از match تکراری** — بعد از هر چت، ۱۰ دقیقه امکان match مجدد با همون کاربر وجود نداره
...
- **بازگشت خودکار سکه** — اگه چت کمتر از ۳ پیام داشته باشه (ناموفق)، سکه‌ی کاربری که هزینه کرده برگشت داده می‌شه
