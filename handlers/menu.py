...
HELP_TEXT = (
    ...
    "🥷 لینک ناشناس من — لینک اختصاصی برای دریافت پیامِ ناشناس\n"
    "🏠 اتاق چت — ساختن یا عضویت در یه اتاقِ گروهیِ دائمی\n\n"
    "پروفایلِ عمومی:\n"
    ...
    "/stop — پایان گفتگو یا خروج از صف انتظار\n"
    "/settings — تنظیمات شخصی (ترجیح جنسیت و غیره)\n"
    "/silent — فعال/غیرفعال‌کردنِ حالتِ سایلنت (جلوگیری از دریافتِ درخواستِ چت)\n"
    "/room — وضعیتِ اتاقِ چتِ فعلیت، یا منوی ساختن/عضویت اگه اتاقی نداری\n\n"
